<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddStaffPositions.aspx.cs" Inherits="AdminPanel.AddStaffPositions" %>
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    %>
                                    <td><%=item.id %></td>
                                    <td><%=item.StaffJobPositionTR  %></td>
                                    <%} %>
                                    <% 
                                        else if (test == "en-US")
                                        {%>
                                    <td><%=item.id %></td>
                                    <td><%=item.StaffJobPositionEN  %></td>
                                    <%} %>
                                    <td>
                                        <div class="col-lg-2 col-md-2 col-sm-1">
                                            <p><a href="/AddStaffPositions.aspx?Process=EditCategoryName&id=<%= item.id %>"><%= AdminPanel.Resources.Index.Edit %></a></p>
                                            <p><a href="/AddStaffPositions.aspx?Process=DeleteCategoryName&id=<%= item.id %>"><%= AdminPanel.Resources.Index.Delete %></a></p>
                                        </div>
