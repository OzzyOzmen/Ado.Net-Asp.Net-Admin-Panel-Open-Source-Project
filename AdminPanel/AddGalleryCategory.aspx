<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddGalleryCategory.aspx.cs" Inherits="AdminPanel.AddGalleryCategory" %>
        ...
        <div class="box">
                ...
                <div class="box-body">
                    <form role="form">
                        ...
                        <div class="box-footer">
                            <input type="button" runat="server" class="btn btn-primary" id="btnUpdate" onserverclick="BtnUpdate_ServerClick"  name="name" value='Save' visible="True"  />
            ...
            <div class="box">
                <div class="box-body">
                    <!-- general form elements disabled -->
                    <div class="box-header with-border">
                        <h3 class="box-title"><%=AdminPanel.Resources.Index.GalleryCategoryList %></h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    %>
                                    <td><%=item.id %></td>
                                    <td><%=item.GaleryCategoryNameTR  %></td>
                                    <%} %>
                                    <% 
                                        else if (test == "en-US")
                                        {%>
                                    <td><%=item.id %></td>
                                    <td><%=item.GaleryCategoryNameEN  %></td>
                                    <%} %>
                                    <td>
                                        <div class="col-lg-2 col-md-2 col-sm-1">
                                            <p><a href="/AddGalleryCategory.aspx?Process=EditCategoryName&id=<%= item.id %>"><%= AdminPanel.Resources.Index.Edit %></a></p>
                                            <p><a href="/AddGalleryCategory.aspx?Process=DeleteCategoryName&id=<%= item.id %>"><%= AdminPanel.Resources.Index.Delete %></a></p>
                                        </div>
