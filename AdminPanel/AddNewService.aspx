<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" ValidateRequest="false" CodeBehind="AddNewService.aspx.cs" Inherits="AdminPanel.AddNewService" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <!-- content -->
    <section class="content">
        <% if (Prcs == Process.AddService || Prcs == Process.EditService)
            {
            ...
            <div class="box-body">
                ...
                <div class="box-body">
                    <form role="form">
                            ...
                            <div class="tab-content">
                                <div class="active tab-pane" id="Türkçe">
                                    ...
                                    <ul>
                                        ...
                                        <div class="form-group">
                                            <label><%=AdminPanel.Resources.Index.TurkishServicesTitle %></label>
                                            <input type="text" id="txtTurkishTitle" runat="server" class="form-control" placeholder="">
                                        </div>
                                        <div class="form-group">
                                            <label><%=AdminPanel.Resources.Index.TurkishServiceDescription %> </label>
                                ...
                                <div class="tab-pane" id="İngilizce">
                                    ...
                                    <ul>
                                        ...
                                        <div class="form-group">
                                            <label><%=AdminPanel.Resources.Index.EnglishServicesTitle %></label>
                                            <input type="text" id="txtEnglishTitle" runat="server" class="form-control" placeholder="">
                                        </div>

                                        <div class="form-group">
                                            <label><%=AdminPanel.Resources.Index.EnglishServiceDescription %></label>
                        ...
                        <!--- Tab Bitiş ----->
                        <div class="form-group">
                            <label><%=AdminPanel.Resources.Index.AddServicesPhotos %></label>
                        </div>
