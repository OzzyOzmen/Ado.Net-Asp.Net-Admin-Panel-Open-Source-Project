<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddReferenceCategory.aspx.cs" Inherits="AdminPanel.AddReferenceCategory" %>
        ...
        <div class="box">
            ...
            <div class="box">
                <div class="box-body">
                    <!-- general form elements disabled -->
                    <div class="box-header with-border">
                        <h3 class="box-title"><%=AdminPanel.Resources.Index.ReferenceCategoryList %></h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    %>
                                    <td><%=item.id %></td>
                                    <td><%=item.ReferenceCategoryNameTR  %></td>
                                    <%} %>
                                    <% 
                                        else if (test == "en-US")
                                        {%>
                                    <td><%=item.id %></td>
                                    <td><%=item.ReferenceCategoryNameEN  %></td>
                                    <%} %>
                                    <td>
                                        <div class="col-lg-2 col-md-2 col-sm-1">
                                            <p><a href="/AddReferenceCategory.aspx?Process=EditCategoryName&id=<%= item.id %>"><%= AdminPanel.Resources.Index.Edit %></a></p>
                                            <p><a href="/AddReferenceCategory.aspx?Process=DeleteCategoryName&id=<%= item.id %>"><%= AdminPanel.Resources.Index.Delete %></a></p>
                                        </div>
