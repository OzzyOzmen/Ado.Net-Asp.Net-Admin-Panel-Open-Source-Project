<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddNewGallery.aspx.cs" Inherits="AdminPanel.AddNewGallery" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
<!-- content -->
    <section class="content">
        <% if (Prcs == Process.AddGallery || Prcs == Process.EditGallery)
            {
            ...
            <div class="box-body">
                ...
                <div class="box-body">
                    <form role="form">
                            ...
                            <div class="tab-content">
                                <div class="active tab-pane" id="Türkçe">
                                    ...
                                    <ul>
                                        ...
                                        <div class="form-group">
                                            <label><%=AdminPanel.Resources.Index.TurkishGalleryName %></label>
                                ...
                                <div class="tab-pane" id="İngilizce">
                                    ...
                                    <ul>
                                        ...
                                        <div class="form-group">
                                            <label><%=AdminPanel.Resources.Index.EnglishGalleryName %></label>
                        ...
                        <div class="form-group">
                            <label><%=AdminPanel.Resources.Index.AddGalleryPhoto %></label>
                        </div>
