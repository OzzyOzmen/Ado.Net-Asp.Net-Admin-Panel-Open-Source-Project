<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" ValidateRequest="false" CodeBehind="AddNewReference.aspx.cs" Inherits="AdminPanel.AddNewReference" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <!-- content -->
    <section class="content">
        <% if (Prcs == Process.AddReference || Prcs == Process.EditReference)
            {
            ...
            <div class="box-body">
                ...
                <div class="box-body">
                    <form role="form">
                            ...
                            <div class="tab-content">
                                <div class="active tab-pane" id="Türkçe">
                                    ...
                                    <ul>
                                        ...
                                        <div class="form-group">
                                            <label><%=AdminPanel.Resources.Index.TurkishReferenceTitle %></label>
                                            <input type="text" id="txtTurkishTitle" runat="server" class="form-control" placeholder="">
                                        </div>
                                        <div class="form-group">
                                            <label><%=AdminPanel.Resources.Index.TurkishReferenceDescription %> </label>
                                ...
                                <div class="tab-pane" id="İngilizce">
                                    ...
                                    <ul>
                                        ...
                                        <div class="form-group">
                                            <label><%=AdminPanel.Resources.Index.EnglishReferenceTitle %></label>
                                            <input type="text" id="txtEnglishTitle" runat="server" class="form-control" placeholder="">
                                        </div>

                                        <div class="form-group">
                                            <label><%=AdminPanel.Resources.Index.EnglishReferenceDescription %></label>
                        ...
                        <div class="form-group">
                            <label><%=AdminPanel.Resources.Index.UploadReferenceLogo %></label>
                        </div>
