<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddNewStaff.aspx.cs" Inherits="AdminPanel.AddNewStaff" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <!-- content -->
    <section class="content">
        <% if (Prcs == Process.AddStaff || Prcs == Process.EditStaff)
            {
                ...
                <div class="box-body">
                    <form role="form">
                        ...
                        <div class="form-group">
                            <label><%=AdminPanel.Resources.Index.StaffName %></label>
                            <input type="text" id="txtStaffName" runat="server" class="form-control" placeholder="">
                        </div>
                         <div class="form-group">
                            <label><%=AdminPanel.Resources.Index.StaffNumber %></label>
                            <input type="text" id="txtStaffNumber" runat="server" class="form-control" placeholder="">
                        </div>
                         <div class="form-group">
                            <label><%=AdminPanel.Resources.Index.StaffEmail %></label>
                            <input type="text" id="txtStaffEmail" runat="server" class="form-control" placeholder="">
                        </div>

                        <div class="form-group">
                            <label><%=AdminPanel.Resources.Index.ChoseStaffPosition %></label>


                            <asp:DropDownList ID="ddlStaffPosition" runat="server" class="form-control select2" data-placeholder="Choose Category">
                        ...
                        <div class="form-group">
                            <label><%=AdminPanel.Resources.Index.UploadStaffProfilePhoto %></label>
                        </div>
